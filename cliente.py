...
from utils.BosqueAleatorio import BosqueAleatorio
...
def escoger_modelo(tipo_modelo: str, pesos_clases = None) -> Modelo:
    ...
    if tipo_modelo == "red_neuronal_desbalanceo":
        ...
        keras.layers.Dense(5, activation="relu"),
        keras.layers.Dropout(0.3),
        keras.layers.Dense(1, activation="sigmoid")], "pesos_clases": pesos_clases})
        return modelo
...
def main():
    ...
    clases_pesos = {0:weight_for_0,1:weight_for_1, 3:weight_for_3}
